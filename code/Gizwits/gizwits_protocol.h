...
* @{
*/
#define PRODUCT_KEY "8fbc252cc60c4adb880551d75b139395"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "a9ac5869af614ca68650fc2d84d5a6e8"
...
* @{
*/
#define SPK_BYTEOFFSET                    0
#define SPK_BITOFFSET                     0
#define SPK_LEN                           1
#define JD_BYTEOFFSET                    0
#define JD_BITOFFSET                     1
#define JD_LEN                           1
#define LED_BYTEOFFSET                    0
#define LED_BITOFFSET                     2
#define LED_LEN                           1
#define ModeButton_BYTEOFFSET                    0
#define ModeButton_BITOFFSET                     3
#define ModeButton_LEN                           1

#define TempTH_RATIO                         1
#define TempTH_ADDITION                      0
#define TempTH_MIN                           0
#define TempTH_MAX                           100
#define TempLH_RATIO                         1
#define TempLH_ADDITION                      0
#define TempLH_MIN                           0
#define TempLH_MAX                           100
#define HumiHT_RATIO                         1
#define HumiHT_ADDITION                      0
#define HumiHT_MIN                           0
#define HumiHT_MAX                           100
#define HumiLT_RATIO                         1
#define HumiLT_ADDITION                      0
#define HumiLT_MIN                           0
#define HumiLT_MAX                           100
#define SoilHumiHT_RATIO                         1
#define SoilHumiHT_ADDITION                      0
#define SoilHumiHT_MIN                           0
#define SoilHumiHT_MAX                           100
#define SoilHumiLT_RATIO                         1
#define SoilHumiLT_ADDITION                      0
#define SoilHumiLT_MIN                           0
#define SoilHumiLT_MAX                           100
#define LightHT_RATIO                         1
#define LightHT_ADDITION                      0
#define LightHT_MIN                           0
#define LightHT_MAX                           100
#define LightLT_RATIO                         1
#define LightLT_ADDITION                      0
#define LightLT_MIN                           0
#define LightLT_MAX                           100
#define temp_RATIO                         1
...
#define Humi_MIN                           0
#define Humi_MAX                           100
#define SoilHumi_RATIO                         1
#define SoilHumi_ADDITION                      0
#define SoilHumi_MIN                           0
#define SoilHumi_MAX                           100
...
typedef enum
{
    ModeButton_VALUE0 = 0,//0
    ModeButton_VALUE1 = 1,//1
    ModeButton_VALUE_MAX,
} ModeButton_ENUM_T;
...
typedef struct {
    ...
    bool valueJD;
    bool valueLED;
    uint32_t valueModeButton;
    uint32_t valueTempTH;
    uint32_t valueTempLH;
    uint32_t valueHumiHT;
    uint32_t valueHumiLT;
    uint32_t valueSoilHumiHT;
    uint32_t valueSoilHumiLT;
    uint32_t valueLightHT;
    uint32_t valueLightLT;
    uint32_t valuetemp;
    uint32_t valueHumi;
    uint32_t valueSoilHumi;
    uint32_t valueLight;
} dataPoint_t;
...
typedef struct {
    ...
    uint8_t flagJD:1;
    uint8_t flagLED:1;
    uint8_t flagModeButton:1;
    uint8_t flagTempTH:1;
    uint8_t flagTempLH:1;
    uint8_t flagHumiHT:1;
    uint8_t flagHumiLT:1;
    uint8_t flagSoilHumiHT:1;
    uint8_t flagSoilHumiLT:1;
    uint8_t flagLightHT:1;
    uint8_t flagLightLT:1;
} attrFlags_t;
...
typedef struct {
    ...
    uint8_t valueHumiHT;
    uint8_t valueHumiLT;
    uint8_t valueSoilHumiHT;
    uint8_t valueSoilHumiLT;
    uint8_t valueLightHT;
    uint8_t valueLightLT;
} attrVals_t;
