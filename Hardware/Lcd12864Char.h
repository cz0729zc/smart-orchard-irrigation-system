#ifndef _LCD_12864_Char_H_
#define _LCD_12864_Char_H_

#include "stm32f10x.h"  //包含需要的头文件

// 引脚定义
#define LCD_DATA_PORT GPIOA  // D0-D7接PA0-PA7
#define LCD_CTRL_PORT GPIOC  // 控制信号端口

// 控制线定义
#define LCD_EN_PIN  GPIO_Pin_15  // EN接PC15
#define LCD_RW_PIN  GPIO_Pin_14  // RW接PC14
#define LCD_RS_PIN  GPIO_Pin_13  // RS接PC13（用户描述中的RD可能实际是RS信号）
